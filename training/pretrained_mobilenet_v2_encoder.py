...
model_info = model_info_io.Info(input_shape, model_info_io.ModelType.PRETRAINED_MOBILENET_V2_ENCODER_RESNET_UNET)
model,pretrained_model = models.residual_unet_with_mobilenet_v2_pretrained_input(input_shape)
...
if not model_only:
    ...
    history_2 = model.fit(train_dataset, epochs=epochs, validation_data=test_dataset,
                                            callbacks=[tensorboard_callback, model_checkpoint_callback])
