...
model_info = model_info_io.Info(input_shape, model_info_io.ModelType.PRETRAINED_VGG19_ENCODER_RESNET_UNET)
model, pretrained_model = models.residual_unet_with_vgg19_pretrained_input(input_shape)
