...
model_info = model_info_io.Info(input_shape, model_info_io.ModelType.DILATED_VIS_ATTN_UNET)
model = models.dilated_visual_attention_residual_unet(input_shape)
